      ...
      <Accordion allowMultiple>
        ...
        <AccordionItem mx="auto" width="75%">
          ...
          <AccordionPanel>
            ...
            <Text my="0.5rem">
              <Trans>
                If you believe your Account Details were stolen, please contact{' '}
              </Trans>{' '}
              <b>
        ...
        <AccordionItem mx="auto" width="75%">
          ...
          <AccordionPanel>
            <Trans>
              Friendly Loans is a service only available to students attending a
              post-secondary institution (College / University) in Nova Scotia
              to access their student loans.
            </Trans>
          </AccordionPanel>
        </AccordionItem>
